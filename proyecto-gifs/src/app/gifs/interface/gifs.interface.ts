// To parse this data:
//
//   import { Convert, SearchGifsInterface } from "./file";
//
//   const searchGifsInterface = Convert.toSearchGifsInterface(json);
//
...
export class Convert {
    public static toSearchGifsInterface(json: string): SearchGifsInterface {
        return cast(JSON.parse(json), r("SearchGifsInterface"));
    }

    public static searchGifsInterfaceToJson(value: SearchGifsInterface): string {
        return JSON.stringify(uncast(value, r("SearchGifsInterface")), null, 2);
    }
}
